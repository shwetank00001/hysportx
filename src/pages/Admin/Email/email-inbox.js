...
const EmailInbox = props => {
  ...
  const [mailsList, setMailsList] = useState(allmail);
  const [activeTab, setactiveTab] = useState(0);
  const [modal, setmodal] = useState(false);
  const mailslists = [
    {id:'1',name:'hhhhh',starred:'1', description:'we are now balancing a fuel meter', date:'29 Feb 2024'},
    {id:'1',name:'hhhhh',starred:'', description:'we are now balancing a fuel meter', date:'29 Feb 2024'},
    {id:'1',name:'hhhhh',starred:'1', description:'we are now balancing a fuel meter', date:'29 Feb 2024'},
    {id:'1',name:'hhhhh',starred:'', description:'we are now balancing a fuel meter', date:'29 Feb 2024'},
    {id:'1',name:'hhhhh',starred:'1', description:'we are now balancing a fuel meter', date:'29 Feb 2024'},
    {id:'1',name:'hhhhh',starred:'2', description:'we are now balancing a fuel meter', date:'29 Feb 2024'},
    {id:'1',name:'hhhhh',starred:'', description:'we are now balancing a fuel meter', date:'29 Feb 2024'},
