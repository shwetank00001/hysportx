...
import SocialLink from 'pages/CommunityList/SocialLink';
import PresentAddress from 'pages/CommunityList/PresentAddress';
import AccountDetails from 'pages/CommunityList/AccountDetails';
    ...
    <div className="page-content">
      <Container fluid >
        ...
        <Breadcrumbs className=''
          ...
          <Row className='my-1' style={{width:'100vw'}}>
          

            <Col xl={4} style={{width:'20vw'}}>
                <Row className='mb-3'>
                 <ProfileCard/>
                {/* <WelcomeComp /> */}
                </Row>
                ...
                <Col xl={5} className='mx-3' style={{width:'37vw'}}>
                <Row>
